...
public class PayrollController {
    ...
    public ResponseEntity<PayrollInfoResponse> createPayroll(
            @PathVariable UUID employeeId,
            @RequestBody(required = false) @Valid PayrollCreateRequest request) {
        return ResponseEntity
                .status(HttpStatus.CREATED)
                .body(payrollService.createPayroll(employeeId, request));
    }
